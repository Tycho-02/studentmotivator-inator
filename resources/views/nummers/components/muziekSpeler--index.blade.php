@if(isset($bestandLocatie))
        <audio id="muziek" preload="true" autoplay>
            ...
            <section id="audioplayer" class="muziekSpeler" >
                <section class="muziekSpeler--info">
                    ...
                    <section class="muziekSpeler--buttons">
                        <i  onclick="vorigNummer({{$afspeellijst}})" id="backwardButton" class="fas fa-step-backward muziekSpeler--play__Button "></i>
                        <i  id="pButton" class="fas fa-play muziekSpeler--play__Button "></i>
                        <i  onclick="volgendNummer({{$afspeellijst}})" id="forwardButton" class="fas fa-step-forward muziekSpeler--play__Button "></i>
                    </section>
    ...
    <!-- zoekt naar een random nummer -->
            ...
            <audio id="muziek" preload="true" autoplay>
                <source id="muziek-audio" src="/muziek/{{$afspeellijstEersteNummer->bestandLocatie}}">
            </audio>
            <section id="audioplayer" class="muziekSpeler" >
                <section class="muziekSpeler--info">
                    <article class="muziekSpeler--info__text">
