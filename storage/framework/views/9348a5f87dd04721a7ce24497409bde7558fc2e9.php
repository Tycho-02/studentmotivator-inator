...
<?php $__env->startSection('content'); ?>
    ...
    <ul>
        ...
        <ul>
            ...
            <?php if($taak->label): ?>
                <li>Label: <?php echo e($taak->label); ?></li>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <a href="/taken/<?php echo e($taak->id); ?>/destroy"><button>Voltooi Taak</button></a>
...
<?php echo $__env->make('taken.taakDefault', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pi/ipmedt5/studentmotivator-inator/resources/views/taken/index.blade.php ENDPATH**/ ?>